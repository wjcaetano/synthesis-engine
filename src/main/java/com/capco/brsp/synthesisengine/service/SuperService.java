...
public class SuperService {
    ...
    public StandardEvaluationContext GPC(Map<String, Object> context) {
        return applicationContext.getBean(ScriptService.class).getSpELContext(context);
    }

    public Object UDE(String expression) {
        return applicationContext.getBean(ScriptService.class).evalSpEL(expression);
    }

    public Object UDE(Map<String, Object> context, String expression) {
        return applicationContext.getBean(ScriptService.class).evalSpEL(context, expression);
    }

    public String GSC(String expression) {
        return applicationContext.getBean(ScriptService.class).getSpELContent(expression);
    }

    public boolean TWM(String expression) {
        return applicationContext.getBean(ScriptService.class).isValidSpEL(expression);
    }

    public Object EPR(String expression) {
        return applicationContext.getBean(ScriptService.class).evalSpELOrReturn(expression);
    }

    public Object EGS(String groovyScript) {
        return applicationContext.getBean(ScriptService.class).evalGroovyByShell(groovyScript);
    }
    ...
    public IExecutor GGE(String scriptContentOrFilePath) throws IOException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        return applicationContext.getBean(ScriptService.class).getGroovyExecutor(scriptContentOrFilePath);
    }
    ...
    public ITransform GGT(String transformName, String scriptContentOrFilePath) throws IOException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        return applicationContext.getBean(ScriptService.class).getGroovyTransform(transformName, scriptContentOrFilePath);
    }

    public String XGT(String content) {
        return applicationContext.getBean(ScriptService.class).evalFreemarker(content);
    }

    public String XGT(Map<String, Object> context, String content) throws IOException, TemplateException {
        return applicationContext.getBean(ScriptService.class).evalFreemarker(context, content);
    }

    public String XGT(String name, String content) throws TemplateException, IOException {
        return applicationContext.getBean(ScriptService.class).evalFreemarker(name, content);
    }

    public Object AEE(String value) {
        return applicationContext.getBean(ScriptService.class).autoEvalExpression(value);
    }

    public Object AEE(String value, List<TransformDto> history) {
        return applicationContext.getBean(ScriptService.class).autoEvalExpression(value, history);
    }

    public Object EAT(String content) throws Exception {
        return applicationContext.getBean(ScriptService.class).autoEvalStringTransforms(content);
    }

    public Object EAT(String content, List<TransformDto> history) throws Exception {
        return applicationContext.getBean(ScriptService.class).autoEvalStringTransforms(content, history);
    }

    public String BCF(Map<String, Object> projectContext, String content, List<String> fileNames) throws Exception {
        return applicationContext.getBean(ScriptService.class).handleAgent(projectContext, content, fileNames);
    }

    public Object YTA(String content) throws Exception {
        return applicationContext.getBean(ScriptService.class).autoEval(content);
    }

    public Object YTA(String content, List<TransformDto> history) throws Exception {
        return applicationContext.getBean(ScriptService.class).autoEval(content, history);
    }

    public <T> T EVS(Object param1) {
        return applicationContext.getBean(ScriptService.class).evalIfSpEL(param1);
    }

    public void ADH(List<TransformDto> param1, String param2, String param3, Long param4) {
        applicationContext.getBean(ScriptService.class).addHistory(param1, param2, param3, param4);
    }

    public String SPR(String prompt, AgentDto config) {
        return applicationContext.getBean(LLMSpringService.class).prompt(prompt, config);
    }

    public String SPC(String prompt, AgentDto config) {
        return applicationContext.getBean(LLMSpringService.class).prompt(prompt, config);
    }

    public void SCS() {
        applicationContext.getBean(LLMSpringService.class).startChat();
    }


    public void SEC() {
        applicationContext.getBean(LLMSpringService.class).endChat();
    }

    public void SCL() {
        applicationContext.getBean(LLMSpringService.class).clearTemporaryLLMConfig();
    }

    public ChatResponse SCR(String prompt, AgentDto config) {
        return applicationContext.getBean(LLMSpringService.class).callWithConfig(prompt, config);
    }
    ...
    public String IMV(Map<String, Object> param1, String param2, List<Object> param3) throws Exception {
        return applicationContext.getBean(ScriptService.class).includeMissingVariableDeclarations(param1, param2, param3);
    }
}
